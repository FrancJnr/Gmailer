 ...
 * Generated at: 2019-09-06 12:22:12 UTC
...
public final class index_005fapp_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	if(regsem == null) {
		...
		regmsg = "<h3 style='color:red;'>Applications for "  + regsem;
		regmsg += "	Academic year will soon be opened. Thank you for your interest in Babcock University.</h3><br/>";
	} else {
		regsem = regsem.substring(0, 9);
	...
	if((resultDiv == null) && (getpassword == null)) {
		...
		if(userName.indexOf("@")<3) {
			...
			resultDiv = "The email does not exisit register and a new applicant";
		} else {
		...
		if(entityName == null) {
			...
			if(studentExist == null) {
				String inSql = "INSERT INTO entitys (entity_type_id, org_id, entity_name, user_name, primary_email, primary_telephone, selection_id) VALUES (20, 0, '";
	...
	db.close();
      ...
      out.write("\t\t\t\t\t\t\t<form class=\"standard\" id=\"baraza\" name=\"baraza\" method=\"post\" action=\"index_app.jsp\">\n");
      out.write("\t\t\t\t\t\t\t\t<table class=\"field\" id=\"formtable\">\n");
      out.write("\t\t\t\t\t\t\t\t<tbody>\n");
      out.write("\t\t\t\t\t\t\t\t<tr>\n");
      out.write("\t\t\t\t\t\t\t\t<td style=\"width: 150px; vertical-align: top;\">Full Name * : </td><td><input name=\"entity_name\" class=\"w_50\" size=\"50\" type=\"text\"></td></tr>\n");
      out.write("\t\t\t\t\t\t\t\t<tr>\n");
      out.write("\t\t\t\t\t\t\t\t<td style=\"width: 150px; vertical-align: top;\">Email * : </td><td><input name=\"user_name\" class=\"w_50\" size=\"50\" type=\"text\"></td></tr>\n");
      out.write("\t\t\t\t\t\t\t\t<tr>\n");
      out.write("\t\t\t\t\t\t\t\t<td style=\"width: 150px; vertical-align: top;\">Confirm Email * : </td><td><input name=\"primary_email\" class=\"w_50\" size=\"50\" type=\"text\"></td></tr>\n");
      out.write("\t\t\t\t\t\t\t\t<tr>\n");
      out.write("\t\t\t\t\t\t\t\t<td style=\"width: 150px; vertical-align: top;\">Phone Number * : </td><td><input name=\"primary_telephone\" class=\"w_50\" size=\"50\" type=\"text\"></td></tr>\n");
      out.write("\t\t\t\t\t\t\t\t<tr>\n");
      ...
      out.print( regsem );
      out.write(" Undergraduate Admissions page. Please follow the instructions carefully. Go to http://application.Babcock.edu.ng to start the application process.</p>\n");
      out.write("\n");
      out.write("                    \t<h3 class=\"widgettitle\">Step 1</h3>\n");
      out.write("\t\t\t\t\t\t<p>A new Applicant: Create login details to obtain your Password</br></p>\n");
      out.write("                    \t<h3 class=\"widgettitle\">Step 2</h3>\n");
      out.write("\t\t\t\t\t\t<p>Log-in with your Username as your email address and Password as sent to your email address.</br></p>\n");
      out.write("\n");
      out.write("\n");
      out.write("\n");
      out.write("                    \t<h3 class=\"widgettitle\">Step 3</h3>\n");
      out.write("\t\t\t\t\t\t<p>On the Left Panel do the following:<br/></p>\n");
      out.write("\t\t\t\t\t\t<p>* Click to fill Form. Make sure you fill all information requested for.<br/></p>\n");
      out.write("\t\t\t\t\t\t<p>* Click <Save> button to save form if you have filled every information.<br/></p>\n");
      out.write("\t\t\t\t\t\t<p>* Upload your Passport Photograph according to the specified size, and JPG or PNG format.<br/></p>\n");
      out.write("\t\t\t\t\t\t<p>* Select Screening Centre and Date of Screening.<br/></p>\n");
      out.write("\t\t\t\t\t\t<p><b>Payments:</b> Take the APPLICATION ID to the bank (Wema, Diamond,GTB,First Bank SkyBank, UBA).Tell the Teller you are paying for Babcock Application Fees. The fee is â¦2,000.00. Service charge is â¦350.00. Total â¦2,350.00.<br/></p>\n");
      out.write("\t\t\t\t\t\t<p>Once payment is done, then log in to the application system and Click Submit.<br/></p>\n");
      out.write("\t\t\t\t\t\t<p>Follow all instructions on the left menu, and be sure you print your completed Application Form.<br/></p>\n");
      out.write("\n");
      out.write("\t\t\t\t\t\t<h3 class=\"widgettitle\"></h3>\n");
      out.write("\t\t\t\t\t\t<p>For further assistance you can email : admissions [at] babcock.edu.ng or call 08148840735, 08162835333, 08183277727</p>\n");
      out.write("\n");
      out.write("                    </div>\n");
      out.write("\n");
      out.write("                \t<div class=\"widget\">\n");
      ...
      out.write("            <div class=\"container_12\">\n");
      out.write("            \t<div class=\"grid_12\">\n");
      out.write("                    <p class=\"left\">&copy; 2014 - <a href=\"http://www.babcock.edu.ng/\" title=\"Babcock Website\">Babcock University</a> | Powered by \t\t<a href=\"http://www.dewcis.com/products/baraza-product-family\" title=\"Openbaraza\"> Openbaraza</a></p>\n");
