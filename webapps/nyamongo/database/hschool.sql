...
CREATE VIEW public.vw_fee_payments AS
 SELECT accountants.accountant_id,
   ...
   FROM ((((public.fee_payments
     JOIN public.accountants ON ((fee_payments.accountant_id = accountants.accountant_id)))
     JOIN public.payment_methods ON ((fee_payments.payment_method_id = payment_methods.payment_method_id)))
...
0	0	0	0	0	root	root	root@localhost	\N	t	t	f	\N	2019-09-19 09:29:12.395727	t	2019-09-25 20:48:12.395772	b6f0038dfd42f8aa6ca25354cd2e3660	baraza	\N	\N	f	\N	\N
\.
...
COPY public.fees_structure (fees_structure_id, school_term_id, org_id, class_level_id, amount, fees_structure_year, is_current, details) FROM stdin;
\.
...
1	\N	\N	1	2019-01-03	2018-03-08	\N	\N	t	\N
2	\N	\N	1	2019-09-02	2019-09-12	\N	\N	f	1
3	\N	\N	2	2019-11-05	2019-09-28	\N	\N	f	1
4	\N	\N	3	2019-12-22	2019-12-31	\N	\N	f	1
\.
...
COPY public.students (student_id, admission_no, org_id, first_name, second_name, surname, gender, address, dob, fname, mname, mphone_no, fphone_no, class_level_id, stream_id, is_suspended, is_active, details) FROM stdin;
\.
...
SELECT pg_catalog.setval('public.accountants_accountant_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.employee_designations_employee_designation_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.employee_month_employee_month_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.employee_types_employee_type_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.entity_subscriptions_entity_subscription_id_seq', 2, true);
...
SELECT pg_catalog.setval('public.entitys_entity_id_seq', 1, true);
...
SELECT pg_catalog.setval('public.fees_structure_fees_structure_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.payment_modes_payment_mode_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.sys_audit_trail_sys_audit_trail_id_seq', 27, true);
...
SELECT pg_catalog.setval('public.sys_logins_sys_login_id_seq', 4, true);
