remove:
- ajax: remove src/ajax folder ajax.js
- effects: remove src/effects folder effects.js
- queue: remove src/quque folder
- deprecated.js: bind、unbind等不需要的事件方法
- serialize.js： 不进行Http请求，不需要序列化方法
- queue： 队列方法不适用
- wrap.js
