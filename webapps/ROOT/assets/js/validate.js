...
function GetAllProperties() {
    ...
    //$.ajax({
    //    cache: false,
    //    url: 'https://demo.dewcis.com/aua/jsongeneral?xml=web/general.xml&view=18:0',
    //    type: 'GET',
    //    dataType: "json",
    ...
    //                mastersCourses += '<li>'
    //                    +'<div><a href="'+data[value].CL+'"><figure><img src="img/course_6_thumb.jpg" alt="" class="img-rounded"></figure>'
    ...
    Object.keys(data).forEach(function(value, key) {
        ...
        if(data[value].degree_level_name == masters){
            mastersCourses += '<li>'
                +'<div><a  class="selector" href="'+data[value].CL+'"><figure><img src="img/course_6_thumb.jpg" alt="" class="img-rounded"></figure>'
                +' <h3>'+ data[value].degree_name +'</h3><small>Start 3 October 2015</small></a></div>'
                +'</li>';
        }else if(data[value].degree_level_name == doctorateMinistryCourses){
            doctorateCourses += '<li>'
                +'<div><a  class="selector" href="#"><figure><img src="img/course_6_thumb.jpg" alt="" class="img-rounded"></figure>'
                +' <h3>'+ data[value].degree_name +'</h3><small>Start 3 October 2015</small></a></div>'
                +'</li>';
        }else if(data[value].degree_level_name == philosophyMinistryCourses){
            philosophyCourses += '<li>'
...
jQuery(document).ready(function(){
    ...
    //        ajax: {
    //            url: 'https://demo.dewcis.com/aua/jsongeneral?xml=web/general.xml&view=18:0', // URL to the JSON script
