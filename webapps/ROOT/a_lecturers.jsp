...
<c:set var="mainPage" value="a_lecturers.jsp" scope="page" />
...
<%
	...
	String xmlcnf = "web/lecturers.xml";
...
<div class="page-header navbar navbar-fixed-top">
	...
	<div class="page-header-inner">
		...
		<div class="page-logo">
			<a href="index.jsp">
				<img src="./assets/logos/aua.png" alt="logo" style="margin: 5px 5px 0 2px; width: 277px; height:50px" class="logo-default"/>
			</a>
