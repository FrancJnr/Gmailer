        ...
        init: function () {
            ...
            form.validate({
                ...
                errorPlacement: function (error, element) { // render error placement for each input type
                    ...
                    }else if (element.attr("name") == "theology_seminary") { // for uniform checkboxes, insert the after the given container
                        error.insertAfter("#form_theology_seminary_error");
                    ...
                    }else if (element.attr("name") == "self_sponsored") { // for uniform checkboxes, insert the after the given container
            ...
            $('#form_wizard_1 .button-submit').click(function () {
                    var json = $('#submit_form').serializeArray();
                    var jsonData = {};
                    $.each(json, function (i, field) {
                        jsonData [field.name] = field.value;
                    });
                console.log(jsonData);
                    $.post("auth", {tag:"registration",json:JSON.stringify(jsonData)}, function(data){
                        if(data.success == 1){
                            console.log("success");
                        }
                        if(data.success == 0){
                            var errorMsg = '<div class="alert alert-danger">'
                                ...
                                +'</div>';
                            $("#error-message").show().html(errorMsg);
                            console.log("fail");
                        }
                    });
            }).hide();
