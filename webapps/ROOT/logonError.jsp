...
<head>
    ...
    <title>Open Baraza University | Logon Error</title>
    ...
    <div id="intro_txt">
        ...
        <div class="container">
            <div class="sub_header_contact_home_wrapper">
                <div id="message-contact-home" style="display: block;margin-bottom: 20px;">
                    <div class="error_message" style="color:#ffd200">Invalid Username/Password.</div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group text-center">
                                ...
                                <a href="/a_admissions.jsp?view=1:0" class="button"><i class="icon-login"></i> Try Again</a>
                            </div>
                        </div>
                    </div>
                </form>
