...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="./assets/jsgrid/jsgrid-theme.css" />
				...
				<div class="col-md-12" >
					...
					<div class="portlet box <%= web.getViewColour() %>">
						...
						<div class="portlet-title">
							...
							<%= web.getButtons() %>
							<div class="actions">
								<a id = "btn_search" class="btn green btn-sm" ><i class="fa fa-search"></i>   Search</a>
